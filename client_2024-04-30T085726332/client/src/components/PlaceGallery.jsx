...
export default function PlaceGallery({place}) {
  ...
  return (
    <div className="relative">
      <div className="grid gap-2 grid-cols-[2fr_1fr] lg:h-[50rem] rounded-3xl overflow-hidden">
        <div>
          {place.photos?.[0] && (
            <div className=" bg-primary h-[100%]">
              <Image onClick={() => setShowAllPhotos(true)} className=" aspect-square h-[100%] cursor-pointer bg-black" src={place.photos[0]} alt=""/>
            </div>
          )}
        </div>
        <div className="grid">
